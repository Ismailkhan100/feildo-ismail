...
export default function AutomotiveServicesPage() {
  ...
  const features = [
    { title: 'Mobile Dispatch & Booking', icon: '🚗', desc: 'Efficiently schedule and manage mobile service appointments' },
    { title: 'OBD/Diagnostic Logging', icon: '📊', desc: 'Capture and analyze vehicle diagnostic data in real-time' },
    { title: 'Parts Procurement', icon: '🔧', desc: 'Streamline parts ordering and inventory management' },
    { title: 'Fleet Maintenance Plans', icon: '🛠️', desc: 'Create and track customized maintenance schedules' },
    { title: 'Warranty Management', icon: '📑', desc: 'Automate warranty claims and compliance tracking' },
    { title: 'Repair Documentation', icon: '📋', desc: 'Complete digital repair history and documentation' }
  ];
