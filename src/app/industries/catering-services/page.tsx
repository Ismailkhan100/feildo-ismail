...
export default function CateringServicesPage() {
  ...
  const features = [
    { title: 'Event Scheduling', icon: '📅', desc: 'Efficiently schedule and manage catering events and appointments' },
    { title: 'Menu & Ingredient Management', icon: '📋', desc: 'Complete menu planning and ingredient inventory tracking' },
    { title: 'Equipment & Supply Control', icon: '🍽️', desc: 'Track and manage all catering equipment and supplies' },
    { title: 'Staff Rostering', icon: '👨‍🍳', desc: 'Optimize staff scheduling and assignment for events' },
    { title: 'Client Communications', icon: '📞', desc: 'Seamless communication channels with clients and team members' },
    { title: 'Food Safety Tracking', icon: '✅', desc: 'Compliance tracking and food safety monitoring' }
  ];

  const benefits = [
    { title: 'Event Excellence', desc: 'Deliver exceptional catering experiences for every event' },
    { title: 'Food Safety', desc: 'Maintain the highest standards of food safety and compliance' },
    { title: 'Great Client Service', desc: 'Exceed client expectations with professional service' },
    { title: 'Operational Efficiency', desc: 'Streamline operations to maximize productivity and reduce costs' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides comprehensive features including event scheduling, menu & ingredient management, equipment & supply control, staff rostering, client communications, and food safety tracking specifically designed for catering businesses.'
    },
    {
      question: 'How can Catering Services businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines catering operations through optimized scheduling, inventory management, staff coordination, client communication tools, and compliance tracking that help reduce preparation times and maximize resource utilization.'
    },
    {
      question: 'How does the software help with regulatory compliance for Catering Services?',
      answer: 'Fielduo includes built-in compliance tracking with automated reporting, food safety monitoring, temperature logs, and documentation features that ensure you meet health department standards and regulatory requirements.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Catering Services?',
      answer: 'Yes, our platform includes specialized capabilities for last-minute catering requests and emergency scheduling with real-time updates and rapid deployment features.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Catering Services?',
      answer: 'We provide complete inventory management with tracking capabilities for all your food ingredients, catering equipment, and supplies, including maintenance history and lifecycle management in one centralized system.'
    },
    {
      question: 'How does the software enhance customer communication for Catering Services?',
      answer: 'Fielduo enables proactive customer communications via multiple channels, providing real-time updates on event preparation, delivery status, menu changes, and special requests.'
    },
    {
      question: 'What benefits do Catering Services clients see after implementing Fielduo?',
      answer: 'Clients typically experience improved operational efficiency, enhanced food safety compliance, better inventory control, reduced waste, increased customer satisfaction, and higher profitability.'
    }
  ];
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Catering Services</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Mobile catering and food service coordination</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for catering service providers</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Enhance your catering service delivery with proven advantages</p>
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Catering Services solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Elevate Your Catering Services?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading catering service providers who trust Fielduo for their field service management</p>
