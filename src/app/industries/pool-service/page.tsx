...
export default function PoolServicePage() {
  ...
  const faqItems = [
    {
      ...
      answer: "Fielduo provides comprehensive features including chemical level tracking, recurring service schedules, equipment maintenance logs, photo-rich service reports, route optimization, and seasonal opening/closing tools."
    },
    {
      question: "How can Pool Service businesses improve efficiency with field service management software?",
      answer: "Our software helps create more efficient routes, improve customer communication, and provide seasonal flexibility through intelligent scheduling, real-time tracking, and streamlined workflows."
    },
    {
      question: "How does the software help with regulatory compliance for Pool Service?",
      answer: "Fielduo includes chemical tracking and reporting features that ensure you maintain proper water quality standards and meet all regulatory requirements with documentation capabilities."
    },
    {
      question: "Does Fielduo offer emergency response or scheduling for Pool Service?",
      answer: "Yes, we provide emergency scheduling capabilities to handle urgent pool service requests efficiently and maintain customer satisfaction."
    },
    {
      question: "How does Fielduo support inventory, assets, or equipment tracking for Pool Service?",
      answer: "Our platform includes comprehensive equipment maintenance logs and inventory tracking features that monitor chemical levels, equipment status, and maintenance schedules in real-time."
    },
    {
      question: "How does the software enhance customer communication for Pool Service?",
      answer: "Fielduo improves customer communication through photo-rich service reports, automated service reminders, and transparent scheduling updates that keep customers informed."
    },
    {
      question: "What benefits do Pool Service clients see after implementing Fielduo?",
      answer: "Clients typically experience crystal-clear water quality for their customers, more efficient routes, better customer communication, and increased operational flexibility leading to higher profitability."
    }
  ];
  ...
  return (
    ...
    <Navbar />
      <Head>
        <title>Fielduo | Pool Service Management Solutions</title>
        <meta name="description" content="Comprehensive residential and commercial pool maintenance software" />
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-blue-400 to-blue-600 text-white py-20 relative overflow-hidden">
          <div className="absolute top-10 right-10 w-20 h-20 bg-white opacity-10 rounded-full animate-float"></div>
          <div className="absolute bottom-5 left-10 w-16 h-16 bg-white opacity-10 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/3 left-1/4 w-12 h-12 bg-white opacity-10 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
          ...
          <div className="container mx-auto px-4 flex flex-col items-center justify-center text-center relative z-10">
            ...
            <button className={`bg-white text-blue-600 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-gray-100 transition duration-300 transform hover:scale-105 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
              Request a Demo
            </button>
          </div>
          ...
          <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-0">
            <svg className="relative block w-full h-12" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
              <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill fill-white"></path>
            </svg>
          </div>
        </section>
        ...
        <section ref={el => { sectionRefs.current[0] = el; }} className="py-16 opacity-0">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { feature: "Chemical level tracking", icon: "🧪" },
                { feature: "Recurring service schedules", icon: "📅" },
                { feature: "Equipment maintenance logs", icon: "🔧" },
                { feature: "Photo-rich service reports", icon: "📸" },
                { feature: "Route optimization", icon: "🗺️" },
                { feature: "Seasonal opening/closing tools", icon: "🌤️" }
              ].map((item, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1">
                  ...
                  <p className="text-gray-600">Streamline your pool service operations with our advanced {item.feature.toLowerCase()} capabilities.</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section ref={el => { sectionRefs.current[1] = el; }} className="py-16 bg-blue-50 opacity-0">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { benefit: "Crystal-clear water quality", icon: "💎", desc: "Maintain perfect pool chemistry with tracking tools" },
                { benefit: "More efficient routes", icon: "⏱️", desc: "Reduce travel time between appointments" },
                { benefit: "Better customer comms", icon: "📱", desc: "Keep customers informed with automated updates" },
                { benefit: "Seasonal flexibility", icon: "🔄", desc: "Easily manage opening/closing schedules" }
              ].map((item, index) => (
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { title: "Q & A with our experts", desc: "Direct access to our pool service specialists" }
              ].map((item, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-md border-l-4 border-blue-400 transform hover:scale-105 transition duration-300">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row justify-center gap-6 mt-8">
                <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition duration-300">
        ...
        <section ref={el => {sectionRefs.current[5] = el; }} className="py-16 bg-blue-600 text-white opacity-0">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Transform Your Pool Service Business?</h2>
