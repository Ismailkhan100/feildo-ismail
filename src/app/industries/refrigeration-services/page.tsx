...
export default function RefrigerationServicesPage() {
  ...
  const features = [
    { title: 'Temperature Monitoring', icon: '🌡️', desc: 'Real-time tracking and alerts for temperature fluctuations' },
    { title: 'Preventive Maintenance', icon: '🔧', desc: 'Scheduled maintenance to prevent equipment failures' },
    { title: 'Rapid Emergency Service', icon: '🚨', desc: '24/7 emergency response for critical situations' },
    { title: 'Energy Efficiency Tracking', icon: '💡', desc: 'Monitor and optimize energy consumption' },
    { title: 'Food Safety Compliance', icon: '✅', desc: 'Ensure compliance with food safety regulations' },
    { title: 'Asset Inventories', icon: '📋', desc: 'Comprehensive tracking of all refrigeration assets' }
  ];

  const benefits = [
    { title: 'Food Safety Assured', desc: 'Maintain optimal conditions to ensure food safety and quality' },
    { title: 'Lower Energy Usage', desc: 'Reduce operational costs with energy-efficient systems' },
    { title: 'Reliable Uptime', desc: 'Minimize downtime with proactive maintenance' },
    { title: 'Fast Incident Response', desc: 'Quick resolution of issues to prevent business disruption' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides comprehensive features including temperature monitoring, preventive maintenance scheduling, rapid emergency service coordination, energy efficiency tracking, food safety compliance management, and asset inventory tracking specifically designed for refrigeration service businesses.'
    },
    {
      question: 'How can Refrigeration businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines operations through optimized scheduling, real-time communication with technicians, automated maintenance reminders, and data-driven insights that help reduce service times and maximize resource utilization.'
    },
    {
      question: 'How does the software help with regulatory compliance for Refrigeration Services?',
      answer: 'Fielduo includes built-in compliance tracking with automated reporting, temperature logging, and documentation features that ensure you meet food safety standards and regulatory requirements.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Refrigeration Services?',
      answer: 'Yes, our platform includes specialized emergency response capabilities and intelligent scheduling that prioritizes urgent repairs to minimize downtime and prevent spoilage.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Refrigeration Services?',
      answer: 'We provide complete asset management with tracking capabilities for all your refrigeration units, including maintenance history, service records, and lifecycle management in one centralized system.'
    },
    {
      question: 'How does the software enhance customer communication for Refrigeration Services?',
      answer: 'Fielduo enables proactive customer notifications via multiple channels, providing real-time updates on service status, maintenance schedules, and completion times.'
    },
    {
      question: 'What benefits do Refrigeration clients see after implementing Fielduo?',
      answer: 'Clients typically experience improved service efficiency, reduced energy costs, enhanced compliance, better asset management, and reduced operational costs.'
    }
  ];
  ...
  return (
    ...
    <Navbar />
      {/* Hero Section */}
       <section className="relative bg-gradient-to-br from-blue-500 to-cyan-500 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Refrigeration Services</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Commercial refrigeration installation and maintenance</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for refrigeration service providers</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Ensure operational excellence and compliance</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="flex items-start p-5 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-100"
              >
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Refrigeration Services solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-500 to-cyan-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Optimize Your Refrigeration Services?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading refrigeration service providers who trust Fielduo for their field service management</p>
