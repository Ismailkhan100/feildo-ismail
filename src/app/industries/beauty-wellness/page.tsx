...
export default function BeautyWellnessPage() {
  ...
  const features = [
    { title: 'Appointment Booking', icon: '📅', desc: 'Streamlined booking system for mobile beauty and wellness services' },
    { title: 'Service History & Preferences', icon: '📝', desc: 'Track client preferences and service history for personalized care' },
    { title: 'Product Inventory', icon: '🧴', desc: 'Manage your beauty product inventory and track usage' },
    { title: 'Reminders & Confirmations', icon: '🔔', desc: 'Automated appointment reminders and confirmations' },
    { title: 'Staff Scheduling', icon: '👥', desc: 'Efficiently schedule and manage your beauty technicians' },
    { title: 'Payments & Invoices', icon: '💳', desc: 'Seamless payment processing and professional invoicing' }
  ];

  const benefits = [
    { title: 'Convenient Service', desc: 'Bring professional beauty and wellness services directly to your clients' },
    { title: 'Personalized Care', desc: 'Deliver tailored experiences based on client preferences and history' },
    { title: 'Quality Standards', desc: 'Maintain consistent service quality across all appointments' },
    { title: 'Happy Customers', desc: 'Increase client satisfaction with seamless booking and personalized service' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides comprehensive features including appointment booking, service history tracking, product inventory management, automated reminders, staff scheduling, and payment processing specifically designed for beauty and wellness businesses.'
    },
    {
      question: 'How can Beauty & Wellness businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines operations through optimized scheduling, real-time communication with technicians, automated reminders to reduce no-shows, and centralized management of client preferences and history.'
    },
    {
      question: 'How does the software help with regulatory compliance for Beauty & Wellness?',
      answer: 'Fielduo includes built-in compliance tracking with automated reporting, staff certification management, and sanitation protocol checklists that ensure you meet industry standards and regulatory requirements.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Beauty & Wellness?',
      answer: 'Yes, our platform includes specialized last-minute booking capabilities and intelligent scheduling that can accommodate urgent appointments and client emergencies.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Beauty & Wellness?',
      answer: 'We provide complete inventory management with tracking capabilities for all your beauty products, tools, and equipment, including usage history, expiration dates, and replenishment alerts.'
    },
    {
      question: 'How does the software enhance customer communication for Beauty & Wellness?',
      answer: 'Fielduo enables proactive customer notifications via multiple channels, providing real-time updates on appointment status, technician arrival times, and personalized follow-ups.'
    },
    {
      question: 'What benefits do Beauty & Wellness clients see after implementing Fielduo?',
      answer: 'Clients typically experience improved booking efficiency, reduced no-shows, enhanced customer satisfaction, better inventory control, and increased revenue through optimized scheduling.'
    }
  ];
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-indigo-600 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Beauty & Wellness</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Mobile beauty, wellness, and personal care services</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for beauty and wellness providers</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Enhance your service delivery and client satisfaction</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-5 rounded-xl shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">Security is built-in with role-based permissions and full audit logs to protect your business and client data.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Beauty & Wellness solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Transform Your Beauty & Wellness Business?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading beauty and wellness providers who trust Fielduo for their field service management</p>
