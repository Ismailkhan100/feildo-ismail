...
export default function RoofingServicesPage() {
  ...
  const features = [
    { title: 'Project Tracking', icon: '📊', desc: 'Monitor all roofing projects in real-time with comprehensive tracking tools' },
    { title: 'Materials Management', icon: '📦', desc: 'Efficiently manage roofing materials, inventory, and procurement' },
    { title: 'Weather Integration', icon: '🌦️', desc: 'Plan projects around weather conditions with real-time forecasts' },
    { title: 'Quality Inspections', icon: '✅', desc: 'Conduct thorough quality checks and document inspection results' },
    { title: 'Warranty Tracking', icon: '📑', desc: 'Manage and track all warranty information for materials and workmanship' },
    { title: 'Customer Communication', icon: '📞', desc: 'Streamlined communication tools to keep clients informed throughout projects' }
  ];

  const benefits = [
    { title: 'Efficient Projects', desc: 'Complete roofing projects faster with optimized workflows and resource allocation' },
    { title: 'Quality Assurance', desc: 'Maintain high standards with systematic inspection and documentation processes' },
    { title: 'Weather-Smart Plans', desc: 'Reduce delays and protect materials with intelligent weather-aware scheduling' },
    { title: 'Satisfied Clients', desc: 'Enhance customer experience with transparent communication and quality results' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides specialized features for roofing contractors including project tracking, materials management, weather integration, quality inspections, warranty tracking, and customer communication tools.'
    },
    {
      question: 'How can Roofing businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines roofing operations through optimized scheduling, real-time project tracking, automated material ordering, and reduced administrative tasks, allowing your team to focus on quality installations and repairs.'
    },
    {
      question: 'How does the software help with regulatory compliance for Roofing Services?',
      answer: 'Fielduo includes compliance tracking with automated reporting, safety checklist documentation, and warranty management features that ensure you meet industry standards and regulatory requirements for roofing projects.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Roofing Services?',
      answer: 'Yes, our platform includes specialized emergency response capabilities and intelligent scheduling that prioritizes urgent roof repairs, especially after severe weather events.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Roofing Services?',
      answer: 'We provide complete inventory management with tracking capabilities for all your roofing materials, tools, and equipment, including maintenance history and lifecycle management in one centralized system.'
    },
    {
      question: 'How does the software enhance customer communication for Roofing Services?',
      answer: 'Fielduo enables proactive customer notifications via multiple channels, providing real-time updates on project status, weather delays, material deliveries, and completion timelines.'
    },
    {
      question: 'What benefits do Roofing clients see after implementing Fielduo?',
      answer: 'Roofing clients typically experience improved project efficiency, reduced material waste, enhanced customer satisfaction, better compliance tracking, and increased profitability through optimized operations.'
    }
  ];
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-800 to-blue-600 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Roofing Services</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Roof install & repair project management</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for roofing contractors</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Transform your roofing business operations and outcomes</p>
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Roofing Services solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Transform Your Roofing Business?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading roofing contractors who trust Fielduo for their field service management</p>
