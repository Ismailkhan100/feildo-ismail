...
export default function InsuranceServicesPage() {
  ...
  const features = [
    { title: 'Claims Case Management', icon: '📋', desc: 'Streamlined management of insurance claims from initiation to resolution' },
    { title: 'Damage Assessment Tools', icon: '🔍', desc: 'Advanced tools for accurate damage evaluation and documentation' },
    { title: 'Adjuster Scheduling', icon: '📅', desc: 'Efficient scheduling and dispatch of insurance adjusters' },
    { title: 'Photo Documentation', icon: '📸', desc: 'Comprehensive visual evidence collection with timestamp verification' },
    { title: 'Estimate/Report Generation', icon: '📊', desc: 'Automated generation of accurate estimates and detailed reports' },
    { title: 'Policyholder Updates', icon: '🔔', desc: 'Real-time communication with policyholders throughout the claims process' }
  ];

  const benefits = [
    { title: 'Accurate Assessments', desc: 'Precise damage evaluation with comprehensive documentation tools' },
    { title: 'Complete Documentation', desc: 'Thorough evidence collection for claims validation and compliance' },
    { title: 'Efficient Processing', desc: 'Streamlined workflows that reduce claim processing time' },
    { title: 'Professional Service', desc: 'Enhanced customer experience with timely updates and professional handling' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides comprehensive insurance-specific features including claims case management, damage assessment tools, adjuster scheduling, photo documentation, estimate/report generation, and policyholder updates.'
    },
    {
      question: 'How can Insurance businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines insurance operations through optimized adjuster scheduling, automated documentation workflows, real-time communication with policyholders, and data-driven insights that help reduce processing times and improve resource utilization.'
    },
    {
      question: 'How does the software help with regulatory compliance for Insurance Services?',
      answer: 'Fielduo includes built-in compliance tracking with automated reporting, audit trails, and documentation features that ensure you meet industry standards and regulatory requirements for insurance claims processing.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Insurance Services?',
      answer: 'Yes, our platform includes specialized emergency response capabilities and intelligent scheduling that prioritizes urgent claims to minimize processing time and provide faster service to policyholders.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Insurance Services?',
      answer: 'We provide complete asset management with tracking capabilities for all your assessment equipment, including maintenance history and deployment tracking in one centralized system.'
    },
    {
      question: 'How does the software enhance customer communication for Insurance Services?',
      answer: 'Fielduo enables proactive customer notifications via multiple channels, providing real-time updates on claim status, assessment scheduling, and resolution timelines.'
    },
    {
      question: 'What benefits do Insurance clients see after implementing Fielduo?',
      answer: 'Insurance clients typically experience improved claims processing efficiency, reduced resolution times, enhanced customer satisfaction, better documentation accuracy, and reduced operational costs.'
    }
  ];
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Insurance Services</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Inspection, adjusting, and claims documentation</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for insurance service providers</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Enhance your insurance services with measurable improvements</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-5 rounded-xl shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">Security is built-in with role-based permissions and full audit logs to protect your sensitive insurance data.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Insurance Services solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Transform Your Insurance Services?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading insurance providers who trust Fielduo for their claims management and field service operations</p>
