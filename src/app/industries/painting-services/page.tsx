...
export default function PaintingServicesPage() {
  ...
  const features = [
    { title: 'Estimating & Materials', icon: '📋', desc: 'Accurate project estimates and material management for cost control' },
    { title: 'Color & Inventory Management', icon: '🎨', desc: 'Streamline color selection and inventory tracking' },
    { title: 'Weather-Aware Scheduling', icon: '🌤️', desc: 'Intelligent scheduling that accounts for weather conditions' },
    { title: 'Quality Checklists', icon: '✅', desc: 'Comprehensive checklists to ensure consistent quality across all projects' },
    { title: 'Customer Updates', icon: '📱', desc: 'Automated customer communication and progress updates' },
    { title: 'Crew Coordination', icon: '👥', desc: 'Efficient team management and assignment tracking' }
  ];

  const benefits = [
    { title: 'Accurate Planning', desc: 'Precise project estimation and resource allocation' },
    { title: 'Quality Assurance', desc: 'Consistent results through standardized processes' },
    { title: 'Efficient Scheduling', desc: 'Optimized timelines with weather considerations' },
    { title: 'Great Customer Experience', desc: 'Transparent communication and professional service delivery' }
  ];
  ...
  const faqs = [
    {
      ...
      answer: 'Fielduo provides specialized features for painting businesses including estimating & materials management, color & inventory tracking, weather-aware scheduling, quality checklists, customer updates, and crew coordination.'
    },
    {
      question: 'How can Painting businesses improve efficiency with field service management software?',
      answer: 'Our software streamlines operations through optimized scheduling, real-time crew coordination, automated customer communications, and precise materials management, reducing wasted time and resources.'
    },
    {
      question: 'How does the software help with regulatory compliance for Painting Services?',
      answer: 'Fielduo includes built-in compliance tracking with automated reporting, safety checklists, and documentation features that ensure you meet industry standards and regulatory requirements for painting services.'
    },
    {
      question: 'Does Fielduo offer emergency response or scheduling for Painting Services?',
      answer: 'Yes, our platform includes specialized scheduling capabilities that can prioritize urgent painting projects and accommodate last-minute requests with efficient resource allocation.'
    },
    {
      question: 'How does Fielduo support inventory, assets, or equipment tracking for Painting Services?',
      answer: 'We provide complete inventory management with tracking capabilities for all your painting supplies, tools, and equipment, including color matching, usage tracking, and automated reordering in one centralized system.'
    },
    {
      question: 'How does the software enhance customer communication for Painting Services?',
      answer: 'Fielduo enables proactive customer notifications via multiple channels, providing real-time updates on project status, schedule changes, and completion timelines, along with visual progress tracking.'
    },
    {
      question: 'What benefits do Painting clients see after implementing Fielduo?',
      answer: 'Painting clients typically experience improved project efficiency, reduced material waste, enhanced customer satisfaction, better crew utilization, and increased profitability through accurate estimating and scheduling.'
    }
  ];
    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-indigo-600 text-white overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-4 py-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">Painting Services</h1>
          <p className="text-lg md:text-xl mb-8 opacity-90 animate-fade-in-delay">Interior & exterior painting project coordination</p>
      ...
      <section ref={featuresRef} className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Comprehensive tools designed specifically for painting service providers</p>
      ...
      <section ref={benefitsRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Enhance your painting business operations and customer satisfaction</p>
      ...
      <section ref={faqRef} className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">Find answers to common questions about our Painting Services solution</p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to Transform Your Painting Services?</h2>
          <p className="mb-8 max-w-3xl mx-auto opacity-90">Join leading painting service providers who trust Fielduo for their field service management</p>
